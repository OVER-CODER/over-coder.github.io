  ...
  return (
    <div className="md:sticky top-12 flex flex-row-reverse md:flex-col gap-4 md:space-y-8">
      ...
      <div className="w-2/3 md:w-full">
        <h1 className="font-serif text-3xl font-light tracking-wide mb-3 text-[#004953]">
          {aboutMe.name}
        </h1>
        {aboutMe.altName && (
        ...
        <div className="flex gap-6 mb-6">
          {aboutMe.blogUrl && (
            <a
              ...
              className="group inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-[#800020] transition-colors duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
              <ArrowUpRight
        ...
        <div className="space-y-2">
          <a
            ...
            className="inline-flex items-center gap-2 text-sm text-zinc-600 hover:text-[#800020] transition-colors"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Mail size={14} />
          ...
          <br />
          <a
            href={`mailto:${aboutMe.acad_email}`}
            className="inline-flex items-center gap-2 text-sm text-zinc-600 hover:text-[#800020] transition-colors"
            target="_blank"
            rel="noopener noreferrer"
          >
