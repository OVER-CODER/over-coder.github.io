    ...
    <div className="flex flex-col sm:flex-row gap-6">
      ...
      <div className="flex flex-col flex-1">
        <div className="flex flex-row gap-4 items-center mb-2">
          ...
          {publication.award && (
            <div className="group flex px-2 py-1 bg-gradient-to-r from-rose-50 to-rose-100/40 rounded-md items-center shadow-md border border-rose-200/40 relative overflow-hidden hover:rotate-1 transition-all duration-300">
              ...
              <p className="text-xs text-[#800020] font-medium relative">
                {publication.award}
              </p>
            </div>
          )}
        ...
        {publication.tldr && (
          <p className={`text-sm italic text-zinc-600 mt-4 ${shortenTldr ? "line-clamp-1" : ""}`}>
            {publication.tldr}
          </p>
        )}
      </div>
